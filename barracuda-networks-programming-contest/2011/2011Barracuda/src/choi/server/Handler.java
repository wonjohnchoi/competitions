...
public class Handler {
    ...
    public String start_game(HashMap<String, Object> data) {
        ...
        reportln("Input:");
        report(data);
        engine.discard = (Integer) data.get("initial_discard");
        reportln("Output:");
        reportln("");
    ...
    public HashMap<String, Object> get_move(HashMap<String, Object> data) {  
        ...
        if (o.length != 0) {
            HashMap<String, Object> theirMoves = (HashMap<String, Object>)((Object[])o[0])[1] ;
            String theirMove = (String)theirMoves.get("move");
            if (theirMove.equals("illegal") || theirMove.equals("no_move") ||theirMove.equals("timed_out")) {
                
            } else {
                int idx = (Integer)theirMoves.get("idx");
                if(theirMove.equals("take_discard")) {
                    engine.theirs[idx] = engine.discard;
            ...
            /*
            engine.discard = dicard;
            if(engine.discard!= discard) {
                System.out.println("ASSERT: DISCARD DISMATCH?");
            }*/
        }
